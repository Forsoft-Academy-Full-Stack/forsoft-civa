  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="${pageContext.request.contextPath}/supervisor/" class="nav-link">Supervisor CIVA</a>
      </li>
    </ul>
  </nav>
  <!-- /.navbar ------------------------------------------------------->
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- ITENS DO MENU -->
          <li class="nav-item">
            <a href="${pageContext.request.contextPath}/supervisor/index.jsp" class="nav-link">
          ...
          <li class="nav-item">
            <a href="${pageContext.request.contextPath}/supervisor/relatorio.jsp" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="${pageContext.request.contextPath}/supervisor/meusdadossupervisor.jsp" class="nav-link">
              ...
              <li class="nav-item">
                <a href="${pageContext.request.contextPath}/supervisor/idioma.jsp" class="nav-link"> 
                  <i class="far fa-circle nav-icon"></i>
                  <p>
                    Mudar Idioma
                  </p>
              ...
              <li class="nav-item">
                <a href="${pageContext.request.contextPath}/supervisor/manual.jsp" class="nav-link"> 
                  <i class="far fa-circle nav-icon"></i>
                  <p>
                    Manual CIVA
                  </p>
              ...
              <li class="nav-item">
                <a href="${pageContext.request.contextPath}/supervisor/solicitacoessupervisor.jsp" class="nav-link"> 
                  <i class="far fa-circle nav-icon"></i>
                  <p>
