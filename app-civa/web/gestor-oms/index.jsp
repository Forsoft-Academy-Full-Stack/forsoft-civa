...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="${pageContext.request.contextPath}/gestor-oms/" class="brand-link">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <!-- ITENS DO MENU -->
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/gestor-oms/" class="nav-link">
                        ...
                        <li class="nav-item ">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item ">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="${pageContext.request.contextPath}/gestor-oms/ui107.jsp" class="nav-link">
                                                <i class="fas fa-clipboard-check nav-icon"></i>
                                                <p>Consultar Gestor OMS</p>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="${pageContext.request.contextPath}/gestor-oms/ui110.jsp" class="nav-link">
                                                <i class="fas fa-user-plus nav-icon"></i>
                                                <p>Cadastrar Gestor OMS</p>
                                            </a>
                                        </li>
                            ...
                            <!-- Item Pa&iacute;ses do Menu Lateral -->
                            <ul class="nav nav-treeview">
                                <li class="nav-item ">
                                    <a href="#" class="nav-link">
                                        <i class="far fa-flag nav-icon"></i>
                                        <p>
                                            Gerenciar pa&iacute;s
                                            <i class="right fas fa-angle-left"></i>
                                        </p>
                                    </a>
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="${pageContext.request.contextPath}/gestor-oms/ui115.jsp" class="nav-link">
                                                <i class="fas fa-clipboard-check nav-icon"></i>
                                                <p>Consultar pa&iacute;ses</p>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="${pageContext.request.contextPath}/gestor-oms/ui116.jsp" class="nav-link">
                                                <i class="fas fa-user-plus nav-icon"></i>
                                                <p>Cadastrar Pa&iacute;s</p>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="${pageContext.request.contextPath}/gestor-oms/o1cadastrospendentes.jsp" class="nav-link">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="${pageContext.request.contextPath}/gestor-oms/ui121.jsp" class="nav-link">
                                                <i class="fas fa-search nav-icon"></i>
                                                <p>Consultar Vacina </p>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="${pageContext.request.contextPath}/gestor-oms/o3cadastrarvacina.jsp" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="${pageContext.request.contextPath}/gestor-oms/relatorio.jsp" class="nav-link">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="${pageContext.request.contextPath}/gestor-oms/meus-dados.jsp" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                Meus dados
                                            </p>
                                    ...
                                    <li class="nav-item">
                                        <a href="${pageContext.request.contextPath}/gestor-oms/idioma.jsp" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                Mudar Idioma
                                            </p>
                                    ...
                                    <li class="nav-item">
                                        <a href="${pageContext.request.contextPath}/gestor-oms/manual.jsp" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                Manual CIVA
                                            </p>
                                    ...
                                    <li class="nav-item">
                                        <a href="${pageContext.request.contextPath}/gestor-oms/login/" class="nav-link">
