...
public class AdministradorOms {
    ...
    public AdministradorOms(Pessoa pessoa, Docs documento1, Docs documento2, Docs documento3, Endereco endereco, String codigoCiva) {
        this.pessoa = pessoa;
