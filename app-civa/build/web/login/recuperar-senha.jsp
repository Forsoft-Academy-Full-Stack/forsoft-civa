    ...
    <div class="container d-flex align-items-center justify-content-center mt-5 mb-5">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <form action="cod-altera-senha.jsp" method="post">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="submit" data-toggle="modal" data-target="#modal-default" class="btn btn-primary btn-block">ENVIAR</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
